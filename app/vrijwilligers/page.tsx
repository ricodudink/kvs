    ...
    <div className="page-section">
      <header className="page-header">
        ...
        <p className="page-intro">
          Vind jij het leuk om met kinderen te werken? Wil je een gezellige en
          actieve invulling van een deel van de zomervakantie? Dan is De
          Kindervakantiespelen iets voor jou!
        </p>
      </header>
